					...
					success : function(data) {
						...
						if (json.bookList.length == 0) {
							...
							for (var i = 0; i < json.bookList.length; i++) {
								...
								tableStr = tableStr
										+ "<td align='center' style='width:40px'><a class=\"text-info\" id=\"a_"+json.bookList[i].book_id+"\" title=\"添加至收藏夹中\" href=\"javascript:addBookToFormatOS('"
										+ json.bookList[i].book_id
										+ "');\"><span class=\"glyphicon glyphicon-shopping-cart\" id='span_"+json.bookList[i].book_id+"'></span></a></td><tr>";
...
<body>
	...
	<div class="container" id="container">
		<div class="row">
			<div class="col-sm-4">
				<div class="well">
					<p class="lead"><a href="javascript:shoucangjia()">收藏夹 <sup><span class="badge" id="tempBookList">0</span></sup></a></p>
					<p class="tip"><small>临时存放要转换的书目列表</small></p>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="well">
					<p class="lead"><a href="">转换车 <sup><span class="badge">4</span></sup></a></p>
					<p class="tip"><small>存放已经转换的书目列表</small></p>
				</div>
			</div>
			<div class="col-sm-4">
			...
			<table class="table table-bordered table-hover table-condensed">
				...
				<tfoot>
					<tr>
						<td id="colspanAttr">
							<div class="pull-left">
								当前第[<span id="currentPageSpan"><s:property value="currentPage" /></span>]页，共[<span id="pageCountSpan"><s:property value="pageCount" /></span>]页，每页显示[<span id="pageRowCountSpan"><s:property value="pageRowCount" /></span>]条
							</div>
