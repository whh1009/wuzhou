...
<body>
	...
	<div class="container" id="container">
		<div class="row">
			<div class="col-sm-3">
				<button type="button" class="btn btn-warning btn-lg" onclick="zhuanhuanche()">转换车 <sup><span class="badge" id="tempBookList">0</span></sup></button>
			</div>
			<div class="col-sm-9">
	...
	<br />
	<!-- 模态框 -->
    <div class="modal fade in" id="myBookListModal" tabindex="-1" role="dialog" aria-labelledby="myBookListModalLabel" aria-hidden="true">
